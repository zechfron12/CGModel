...
void Display8() {
    ...
    for (int i = 0; i < 6; ++i) {
        glVertex2f(sin(i / 6.0 * (2 * M_PI) + M_PI / 6) * 0.75, cos(i / 6.0 * 2 * M_PI + M_PI / 6) * 0.75);
    }
    ...
    for (int i = 0; i < 6; ++i) {
        glVertex2f(sin(i / 6.0 * 2 * M_PI + M_PI / 6) * 0.5, cos(i / 6.0 * 2 * M_PI + M_PI / 6) * 0.5);
    }
    ...
    for (int i = 0; i < 6; ++i) {
        glVertex2f(sin(i / 6.0 * 2 * M_PI + M_PI / 6) * 0.475, cos(i / 6.0 * 2 * M_PI + M_PI / 6) * 0.475);
    }
    ...
    glBegin(GL_LINE_LOOP);
     k = 0.5;
    for (int i = 0; i < 6; ++i) {
        glVertex2d(sin(i/6.0 * 2 * M_PI + M_PI/6) * k, cos(i / 6.0 * 2 * M_PI + M_PI / 6) * k) ;
    }
    glEnd();
	*/
